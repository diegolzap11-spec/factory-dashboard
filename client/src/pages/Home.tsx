    ...
    <DashboardLayout>
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground text-sm">{APP_NAME} — Monitoreo en tiempo real de producción y despachos</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 stagger-children">
            {products?.map((product) => (
              <Card key={product.id} className="card-premium border-border/40 bg-card/80 backdrop-blur-sm overflow-hidden">
                <CardContent className="p-4">
                  <div className="aspect-square rounded-xl overflow-hidden mb-3 bg-secondary/50">
                    {product.imageUrl ? (
                      <img
